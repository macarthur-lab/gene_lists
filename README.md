...
| [DNA Repair Genes](lists/DRG_WoodRD.tsv) | 178 | An updated inventory of human DNA repair genes. (Last modified on Tuesday 15th April 2014) | Cite [[Wood RD 2005]] and include a web reference to [http://sciencepark.mdanderson.org/labs/wood/dna_repair_genes.html](http://sciencepark.mdanderson.org/labs/wood/dna_repair_genes.html). |
